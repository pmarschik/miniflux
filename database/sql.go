...
create index document_vectors_idx on entries using gin(document_vectors);`,
	"schema_version_21": `alter table feeds add column cookies hstore default '';`,
...
var SqlMapChecksums = map[string]string{
	...
	"schema_version_21": "f080cc4e457dede6adc42cf0c33e000e4e27189cf71da0dedbf0b246c331c558",
